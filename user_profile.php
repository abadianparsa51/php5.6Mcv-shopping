...
if($main->get('logout'))
{
    $main->beforeUserLogout();
    unset($_SESSION['user_id']);
    $main->redirect('login.php?msg=ok-logout');
}
$profile = $main->getUserProfile();


if($main->post('btn_save'))
{
    $resultSaveUser = $main->SaveUserProfile();
    $main->redirect("?msg=$resultSaveUser");
}

if($main->get('del'))
{
    $main->deleteUserProfileAvatar();
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" onclick="redirect('user_profile.php?del=1')">بلی</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    ...
    <div class="col-md-8" id="content">
        ...
        ?>
        <div class="alert alert-info text-center col-sm-10 col-sm-offset-2">
            اطلاعات کاربر:
        </div>
